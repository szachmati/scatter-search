...
class SolutionCombinationMethod:
    def crossover(self, distanceMatrix, RefSet, reverseProb=0.5, scrambleProb=0.3):
        """" Funkcja dokonująca krzyżowania dwóch losowych ścieżek
            :parameter distanceMatrix - macierz sąsiedztwa
            :parameter RefSet
            :parameter reverseProb - próg dla którego odwracane są kolejnością elementy 1 rodzica
            :parameter scrambleProb - próg dla którego mieszane są elementy 2 rodzica
        """
